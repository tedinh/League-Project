angular.module('league').service('sumServ', function($http) {
      ...
      this.getSumData = function(summonerName) {
        return $http.get("https://na1.api.riotgames.com/lol/summoner/v3/summoners/by-name/" + summonerName + "?api_key=RGAPI-190c3364-af58-4499-a132-e2e70aef644f").then(function(response) {
          var idNum = response.data.id;
          return response.data.id;
        })
        .then(function(idNum){
          return $http.get("https://na.api.riotgames.com/api/lol/NA/v1.3/stats/by-summoner/" + idNum + "/summary?season=SEASON2017&api_key=RGAPI-190c3364-af58-4499-a132-e2e70aef644f")
